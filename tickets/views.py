...
def ticket_edit(request, ticket_id):
    ...
    arguments = {"ticket": ticket, "users": staff_users}
...
def ticket_list(request):
    ...
    return render(
        request, "tickets/ticket_list.html", {"tickets": tickets, "form": form}
    )


class test_endpoint(View):
    model = Ticket
    template_name = "tickets/test_endpoint.html"
